...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = isDev
      ...
      : [
          ...
          "script-src 'self' https://app.posthog.com https://vercel.live https://cdn.vercel-insights.com",
          ...
          // Connect: self + Supabase + PostHog + Sentry
  ...
  // middleware.ts, but static redirects can be added here.
  // ---------------------------------------------------------------------------
  async redirects() {
    return [
      // Redirect bare /en root to /  (canonical default locale)
      {
        source: "/en",
        destination: "/",
        permanent: true,
