...
const antivirusData: AntivirusSeed[] = [
  ...
  },
  {
    ...
    logo_url: "https://icon.horse/icon/eset.com",
    pricing_model_id: PRICING_SUBSCRIPTION,
  ...
  },
  {
    ...
    logo_url: "https://icon.horse/icon/norton.com",
    pricing_model_id: PRICING_SUBSCRIPTION,
  ...
  },
  {
    ...
    logo_url: "https://icon.horse/icon/malwarebytes.com",
  ...
  },
  {
    ...
    logo_url: "https://icon.horse/icon/avast.com",
  ...
  },
  {
    ...
    logo_url: "https://icon.horse/icon/microsoft.com",
    pricing_model_id: PRICING_FREE,
    starting_price: 0,
    price_currency: "USD",
    has_free_trial: false,
